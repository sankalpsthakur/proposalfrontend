      ...
      <div className="w-full max-w-4xl bg-gray-800 rounded-3xl overflow-hidden shadow-xl">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 p-8 flex flex-col justify-center">
            <h1 className="text-4xl font-bold mb-4">Proposal Engine</h1>
            <p className="text-xl mb-8">Find the optimal equipment sizing using bidding assumptions, variables, and visualization</p>
